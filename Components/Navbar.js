...
const Navbar = () => {
  return (
    <div className="ml-30 bg-slate-200 px-8 text-gray-500 flex items-center justify-between">
      ...
      <div className="flex items-center space-x-4 md:space-x-8 ml-10 md:ml-0">
        <input
          ...
          className="hidden md:block rounded-md w-60 bg-slate-200 border-sky-100 px-2 py-1"
        />
